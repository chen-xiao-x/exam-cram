...
/* ===== Button ===== */
const Button = ({ variant = 'ghost', size = 'md', icon: Icon, children, style, ...rest }) => {
  const cls = ['btn', `btn-${variant}`];
  if (size === 'sm') cls.push('btn-sm');
  if (size === 'lg') cls.push('btn-lg');
  return <button className={cls.join(' ')} style={style} {...rest}>{Icon && <Icon width={14} height={14} />}{children}</button>;
};
